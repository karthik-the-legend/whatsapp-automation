...
// Plain native <select>, styled to match the rest of the ui/ kit - kept
// dependency-free (no Radix) since none of this dashboard's dropdowns need
// custom option rendering, just a themed native control.
